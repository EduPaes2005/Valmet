...
class Accounts{
    ...
    private function updateLastLogin($id_user) {
        $currentDateTime = date('Y-m-d H:i:s');
        $sql = "UPDATE users SET lastLogin = :lastLogin WHERE id_user = :id_user";
        $stmt = $this->conn->prepare($sql);
        $stmt->bindValue(':lastLogin', $currentDateTime);
